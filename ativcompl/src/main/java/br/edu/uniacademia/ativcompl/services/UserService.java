...
public class UserService {
	...
	public User find(Long id) {
		...
		if (userLogged == null || !userLogged.hasRole(ProfileEnum.ADMIN) && !id.equals(userLogged.getId())) {
	...
	public User fromDTO(UserDTO objDto) {
		return new User(objDto.getRegistration(), objDto.getName(), objDto.getEmail(),
